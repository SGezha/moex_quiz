  ...
  <div id="quiz_widget">
          ...
          <div v-else class="stories">
            ...
            <transition-group name="list">
              <div
                ...
                :key="storie.id"
                :style="`--textColor: ${storie.textColor}; --page: ${storie.id * 100}%;`"
                class="stories_element"
                v-show="storie.id == currentStory.id"
              >
    ...
    <button @click="toggleOpen()" class="button__container">
      <div class="stories_circle">
        ...
        <div v-for="storie in stories" :key="storie.id" :class="`${storie.watched ? 'watched' : ''}`" class="st_circle"></div>
      </div>
